        ...
        function (t, e) {
          t.forEach(function (t) {
            (0 < t.intersectionRatio || t.isIntersecting) &&
              ...
              y(t.target) || (r(t.target), k(t.target), a(t.target)));
          });
        }),
        ...
        (b = new MutationObserver(
          ...
          function (t) {
            t.forEach(function (t) {
              y(t.target) &&
                "attributes" === t.type &&
                -1 < h.indexOf(t.attributeName) &&
                e(t.target);
            });
          })
        ));
    for (var f, m = w(o, n), A = 0; A < m.length; A++)
      (f = m[A]).getAttribute("data-placeholder-background") &&
        (f.style.background = f.getAttribute("data-placeholder-background"));
    return {
      observe: function () {
